...
import {
  LayoutDashboard, Users, CalendarCheck, ClipboardList, Eye, Gavel, HeartPulse,
  GraduationCap, FileBarChart, MessageSquare, UserCog, Tablet, ScrollText, Settings, ScanLine,
} from "lucide-react";
...
export const NAVIGATION: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { label: "Learners", to: "/learners", icon: Users, permission: "learners.view", alt: "learners.identity_only" },
  ...
  },
  {
    ...
    items: [
      { label: "Observations", to: "/observations", icon: Eye, permission: "observations.view", alt: "observations.create" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Communication", to: "/communication", icon: MessageSquare, permission: "communication.view" },
